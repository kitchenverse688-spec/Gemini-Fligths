  ...
  return (
    <div className={cardClasses} onClick={() => onSelect(flight)}>
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center p-4 md:p-6">
        ...
        <div className="md:col-span-4 flex items-center justify-between md:justify-center text-center">
            <div className="w-1/3">
        ...
        <div className="md:col-span-2 text-center space-y-1 border-t md:border-t-0 md:border-x border-slate-200 py-2 md:py-0">
            <p className="text-sm font-medium text-slate-700">{flight.stops === 0 ? 'Direct' : `${flight.stops} stop${flight.stops > 1 ? 's' : ''}`}</p>
            <div className="text-xs text-slate-500">
                <p><i className="fa-solid fa-suitcase text-xs mr-1"></i>{flight.baggageAllowance.carryOn}</p>
                <p><i className="fa-solid fa-suitcase-rolling text-xs mr-1"></i>{flight.baggageAllowance.checked}</p>
            </div>
        </div>

        <div className="md:col-span-3 flex flex-col md:flex-row items-center justify-end gap-4 mt-4 md:mt-0 border-t md:border-t-0 pt-4 md:pt-0 md:pl-4">
